...
const stageRoles:Record<string,Role> = { '待部门审批':'manager','待财务复核':'finance','待老板审批':'owner','待出纳付款':'cashier','待财务确认':'finance' };
